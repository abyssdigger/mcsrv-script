...
- removed all aliases and added alias mcsrv that points to the script
...
Existing users need to stop the server with systemctl --user stop mcsrv-tmpfs.service or mcsrv.service
Existing users need to update the script and execute the following paramerers to rebuild updated functions:
